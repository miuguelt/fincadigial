    ...
    try:
        ...
        if flask.request and flask.request.cookies:
            cookie_name = (flask.current_app.config.get('JWT_ACCESS_COOKIE_NAME', 'access_token_cookie')
                           if flask.current_app else 'access_token_cookie')
...
class APIResponse:
    ...
    def success(data: Any = None, message: str = "Operación exitosa",
                status_code: int = 200, meta: dict | None = None,
    ...
    @staticmethod
    def unauthorized(message: str = "Acceso no autorizado", details: dict | None = None) -> tuple:
        """
    ...
    @staticmethod
    def forbidden(message: str = "Acceso prohibido", details: dict | None = None) -> tuple:
        """
    ...
    @staticmethod
    def conflict(message: str = "Conflicto de datos", details: dict | None = None) -> tuple:
        """
...
class ResponseFormatter:
    ...
    @staticmethod
    def format_model_list(model_list, exclude_fields: list[str] | None = None) -> list[dict]:
        """
