...
class MilkProductionList(Resource):
    ...
    def get(self):
        ...
        query = MilkProduction.query.filter_by(finca_id=user_finca.finca_id).order_by(MilkProduction.production_date.desc())
    ...
    def get(self):
        ...
        try:
            stats = db.session.query(
                ...
                func.count(func.distinct(MilkProduction.animal_id)).label('cows_milked'),
            ...
            total_liters = float(stats.total_liters) if stats and stats.total_liters else 0
            ...
            total_records = int(stats.total_records) if stats and stats.total_records else 0
