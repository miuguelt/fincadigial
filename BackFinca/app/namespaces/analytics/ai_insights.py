...
class AIInsights(Resource):
    @ai_ns.doc(
        ...
        params={
            ...
            'finca_id': {'description': 'ID finca para contenido específico', 'type': 'integer'},
        },
        security=['Bearer', 'Cookie'],
        responses={200: 'Insight generado', 401: 'No autorizado', 500: 'Error del servidor'},
    )
    @jwt_required()
    def get(self):
        ...
        try:
            ...
            return APIResponse.error('Error al obtener insights del sistema', status_code=500)
