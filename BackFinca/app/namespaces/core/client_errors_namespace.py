...
client_errors_ns = Namespace(
    'errors',
    description='Recepción de errores del cliente frontend',
    path='/errors'
)

logger = logging.getLogger(__name__)

error_event_model = client_errors_ns.model('ClientErrorEvent', {
...
batch_model = client_errors_ns.model('ClientErrorBatch', {
