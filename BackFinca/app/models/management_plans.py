...
class ManagementPlan(BaseModel):
    ...
    _namespace_fields = [
        'id', 'finca_id', 'name', 'description', 'plan_type', 'status',
        'start_date', 'end_date', 'created_by_user', 'approved_by_user', 'notes',
    ...
    _required_fields = ['finca_id', 'name', 'plan_type', 'start_date', 'end_date', 'created_by_user']
