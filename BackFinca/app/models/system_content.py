...
class SystemContent(BaseModel):
    ...
    _namespace_fields = [
        'id', 'key', 'category', 'content_type', 'priority',
        'title', 'content', 'extra', 'is_active', 'finca_id',
        'created_at', 'updated_at',
    ]
    _filterable_fields = ['key', 'category', 'content_type', 'priority', 'is_active', 'finca_id']
    ...
    @classmethod
    def get_by_category(cls, category: str, finca_id: int = None, content_type: str = None):
