...
class ReproductiveEvent(BaseModel):
    ...
    _namespace_fields = [
        'id', 'animal_id', 'control_id', 'event_type', 'event_date',
    ...
    _filterable_fields = ['animal_id', 'control_id', 'event_type', 'event_date', 'diagnosis_result', 'sire_id', 'finca_id']
            ...
            if 'expected_birth_date' not in d or not d['expected_birth_date']:
                if d.get('event_date'):
                    ...
                    if isinstance(ev_date, _date):
                        ...
                        d['expected_birth_date'] = ev_date + timedelta(days=gestation) if gestation else None
