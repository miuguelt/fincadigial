...
class ICAReportPDF(FPDF):
    ...
    def header(self):
        ...
        title = 'REPORTE DE PRÁCTICAS - FINCA EDUCATIVA' if self.finca_type == 'Educativa' else 'REPORTE OFICIAL ICA'
...
def generate_inventory_pdf(finca_name, finca_data, animals_data, finca_type='Tradicional'):
...
def generate_movements_pdf(finca_name, finca_data, movements_data, finca_type='Tradicional'):
