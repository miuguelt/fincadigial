...
def register_namespaces(api):
    ...
    from ..namespaces.animals.lactation_namespace import lactation_ns
    from ..namespaces.animals.production_target_namespace import target_ns
    ...
    from ..namespaces.analytics.intelligence import ns as intelligence_ns
    ...
    from ..namespaces.core.corral_namespace import corral_ns
    ...
    # NOTA: El alias /activity-log fue registrado dos veces con el mismo objeto Namespace.
    # En Flask-RESTX esto duplica las rutas en Swagger. Se mantiene comentado para
    # preservar compatibilidad de contrato si el frontend lo consume.
    # Si se necesita el alias, crear un Blueprint redirect separado.
