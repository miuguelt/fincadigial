...
def test_parse_activity_datetime():
    ...
    assert _parse_activity_datetime("2026-05-21T10:00:00Z") == datetime.fromisoformat("2026-05-21T10:00:00+00:00")
    assert _parse_activity_datetime("2026-05-21T10:00:00") == datetime.fromisoformat("2026-05-21T10:00:00")
