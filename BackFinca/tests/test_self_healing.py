...
class TestSelfHealing:
    ...
    def test_run_checkup_healthy(self, mock_log, mock_redis, mock_workers, mock_db, mock_cache):
    ...
    @patch('app.services.self_healing_service.SelfHealingManager._check_redis_latency')
    @patch('app.services.self_healing_service.SelfHealingManager._log_healing_action')
    def test_run_checkup_db_unhealthy(self, mock_log, mock_redis, mock_workers, mock_db, mock_cache):
    ...
    @patch('app.services.self_healing_service.SelfHealingManager._check_redis_latency')
    @patch('app.services.self_healing_service.SelfHealingManager._log_healing_action')
    def test_run_checkup_workers_and_redis_unhealthy(self, mock_log, mock_redis, mock_workers, mock_db, mock_cache):
