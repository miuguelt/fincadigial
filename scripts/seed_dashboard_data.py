...
def seed_dashboard_data():
    ...
    with app.app_context():
        print("🐄 [SEED] Iniciando poblado de producción láctea y finanzas para todas las fincas...")
        ...
        for finca in fincas:
            ...
            if not females:
                ...
                if breed:
                    for i in range(5):
                        female = Animals(
                            record=f"HEMBRA-{finca.id}-{i}", sex='Hembra', breeds_id=breed.id,
                            birth_date=date.today() - timedelta(days=1000), weight=400.0,
            ...
            for day in range(90):
                ...
                for _ in range(random.randint(2, 5)):
                    ...
                    db.session.add(Transaction(
                        ...
                        description=f"Transacción automática de {cat.value}"
                    ))
            db.session.commit()
