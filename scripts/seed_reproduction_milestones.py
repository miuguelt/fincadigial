...
MILESTONES = [
    ...
    {
        "day": 90,
        "message": "Control de 1er tercio — revisar nutrición y condición corporal.",
        "priority": "MEDIUM",
    },
    {
        "day": 150,
        "message": "Control de 2do tercio — ajuste de suplementación.",
        "priority": "MEDIUM",
    },
    {"day": 210, "message": "Control de 3er tercio — preparación al parto.", "priority": "HIGH"},
    {
        "day": 223,
        "message": "INICIO DE SECADO obligatorio (60 días pre-parto).",
        "priority": "CRITICAL",
    },
    {
        "day": 250,
        "message": "Trasladar a zona de maternidad o potrero de parto.",
        "priority": "HIGH",
    },
    {
        "day": 270,
        "message": "Alerta de parto inminente — vigilancia 24 horas.",
        "priority": "CRITICAL",
    },
...
with app.app_context():
    ...
    for key, content, extra in entries:
        ...
        if not entry:
            entry = SystemContent(
                key=key, content=content, category="config", content_type="json", extra=extra
            )
