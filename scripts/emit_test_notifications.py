...
def emit_notification(event_bus, notification_type='info'):
    ...
    notifications = {
        ...
        'inventory': {
            ...
            'data': {
                ...
                'days_to_expire': random.randint(5, 15)
            },
            'action': {
    ...
    payload = {
        ...
        'type': notif_type if notif_type not in ['reproduction', 'production', 'inventory'] else 'warning',
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='random',
        choices=['random', 'info', 'success', 'warning', 'error', 'reproduction', 'production', 'inventory'],
    ...
    try:
        ...
        print("Asegúrese de ejecutar desde el directorio BackFinca")
        sys.exit(1)
    except Exception as e:
