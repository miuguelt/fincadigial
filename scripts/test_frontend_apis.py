...
def test_endpoint(name: str, method: str, endpoint: str, token: str, params: dict = None, expected_status: int = 200):
    """Probar un endpoint"""
...
def main():
    ...
    parser.add_argument('--verbose', '-v', action='store_true', help='Mostrar detalles de cada prueba')
