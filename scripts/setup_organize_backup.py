...
def main():
    ...
    print(f"   # Backup semanal (Domingo 3:00 AM):")
    print(f"   {weekly_cmd}")
    print()
...
"""
    ...
    batch_file = project_root / "setup_tasks.bat"
    ...
    print("   📁 backups/                  - Sistema de backup")
    ...
    print("   # Backup manual:")
    print("   python scripts/backup/auto_backup.py --type snapshot --description 'Antes de cambios'")
    print()
    print("   # Ver backups:")
