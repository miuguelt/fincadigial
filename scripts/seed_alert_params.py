...
with app.app_context():
    params = {
        ...
        "param.alert.adg_medium_multiplier": (
            "0.6",
            "Multiplicador ADG medio (fracción del esperado)",
        ),
        ...
        "param.alert.projection_min_multiplier": (
            "0.9",
            "Multiplicador proyección vs mínimo estándar",
        ),
    }
    created = 0
