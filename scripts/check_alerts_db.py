...
with app.app_context():
    ...
    keys_to_check = [
        'weight_loss_severe_pct', 'weight_loss_high_pct',
        'breed_deviation_critical_pct', 'breed_deviation_high_pct', 'breed_deviation_medium_pct',
        'adg_expected_default', 'adg_negative_threshold', 'adg_low_multiplier', 'adg_medium_multiplier',
        'projection_min_multiplier', 'illness_weight_loss_pct', 'lactation_loss_min_pct', 'lactation_loss_max_pct',
        'bcs_critical', 'bcs_high', 'bcs_medium', 'bcs_obese', 'bcs_trend_drop_points'
    ]
