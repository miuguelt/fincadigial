    ...
    <div className="min-h-screen bg-muted dark:bg-stone-950 pb-20 font-sans">
      ...
      <main className="p-4 max-w-lg mx-auto space-y-6 mt-4">
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="h-16 pl-14 rounded-lg bg-muted border-border font-black text-xl"
                  />{" "}
                  <IconScale
                    size="md"
        ...
        <section className="space-y-4">
          ...
          <Card
            className={cn(
              "rounded-[2.5rem] border-none shadow-md text-white overflow-hidden transition-all duration-500",
              calcType === "concentrate"
                ? "bg-emerald-600 shadow-emerald-900/20"
                : "bg-info shadow-blue-900/20",
            )}
          >
            {" "}
