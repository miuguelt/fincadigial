    ...
    <div className="min-h-full bg-background/50 p-4 sm:p-6 lg:p-8 space-y-8 overflow-x-hidden">
      ...
      >
        <div className="flex items-center gap-5">
          <div className="h-14 w-14 sm:h-16 sm:w-16 rounded-xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-xl shadow-primary/20">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground font-medium mt-1">Auditoría de salud y requisitos legales del hato</p>
          </div>
        </div>
          ...
          {data && (
            <>
              <CSVLink data={csvData} filename={`reporte-ica-${new Date().toISOString().split('T')[0]}.csv`}>
                <Button variant="outline" className="rounded-lg h-12 gap-2 border-dashed hover:border-solid transition-all">
              ...
              <Button 
                ...
                className="rounded-lg h-12 gap-2 bg-foreground text-background hover:bg-foreground/90 transition-all shadow-xl shadow-black/10"
              >
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
            <Card className="border-border/50 shadow-xl shadow-primary/5 bg-card/40 backdrop-blur-xl rounded-xl overflow-hidden group hover:-translate-y-1 transition-all duration-300">
              <CardHeader className="pb-2">
                <CardDescription className="font-bold uppercase tracking-widest text-[10px] text-muted-foreground">Hato Total</CardDescription>
