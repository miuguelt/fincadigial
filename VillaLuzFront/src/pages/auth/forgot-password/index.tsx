                ...
                <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl shadow-2xl">
                    ...
                    {successMessage ? (
                        <Alert className="bg-success/5 border-success/30">
                            ...
                            <AlertTitle className="text-success font-medium">¡Solicitud enviada!</AlertTitle>
                            <AlertDescription className="text-success">
                                {successMessage}
                            </AlertDescription>
                            <div className="mt-4">
                                <Link to="/login">
                                    <Button className="w-full bg-success hover:bg-green-700 text-white">
                        ...
                        <form onSubmit={handleSubmit} noValidate className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="identifier" className="text-success">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={`w-full px-10 py-2 border ${error ? 'border-red-400 focus:ring-red-400' : 'border-success/40 focus:ring-green-500'} rounded-md focus:outline-none focus:ring-1`}
                                    />
                                </div>
                                {error && (
                                    <div
