        ...
        <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl shadow-2xl">
          ...
          {isPendingApproval ? (
            ...
            <div className="space-y-2">
              ...
              {errors.identification && (
                <p id="documento-error" className="mt-1 text-sm text-destructive">
                  {errors.identification}
                </p>
              )}
            </div>
          ...
          <div className="text-center mt-6 space-y-2">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/register/user" className="text-success hover:text-success font-medium">
                Crear cuenta
              </Link>
            </p>
            <p className="text-xs text-muted-foreground">
              <Link to="/fincas-disponibles" className="text-success hover:text-success">
                Ver fincas disponibles
              </Link>
              {" · "}
              <Link to="/register/finca" className="text-success hover:text-success">
                Registrar finca
              </Link>
            </p>
          </div>
