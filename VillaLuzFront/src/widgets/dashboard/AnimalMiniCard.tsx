    ...
    <div className={cn("relative flex flex-col items-center", className)}>
        ...
        <div className="mb-2">
          <span
            className={cn(
              ...
              isFather &&
                !isMother &&
                "bg-info/10 dark:bg-blue-900/30 text-info dark:text-blue-300 border-info/40/50",
              isMother &&
                !isFather &&
      ...
      <div
        ...
        className={cn(
          ...
          levelIndex > 0 &&
            sex === "Macho" &&
            "bg-gradient-to-br from-blue-100/80 to-blue-50/50 dark:from-blue-900/20 dark:to-blue-800/10 border-info/40/50",
          levelIndex > 0 &&
            sex === "Hembra" &&
      ...
      >
          ...
          <div className="relative h-48 bg-muted/30 flex items-center justify-center">
            ...
            <div
              className={cn(
                ...
                sex === "Macho" &&
                  "bg-info/20 border-info/50 text-info dark:text-info/80",
                sex === "Hembra" &&
        ...
        <div className="p-4 space-y-2">
          ...
          {animal.breed?.name && (
            <p
              className="text-xs text-muted-foreground truncate px-2.5 py-1 rounded-full bg-background/50 inline-block max-w-full"
