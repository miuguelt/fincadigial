...
export const StatisticsCardSkeleton: React.FC = () => {
  return (
    <div className="w-full max-w-full sm:max-w-sm h-36 sm:h-40 md:h-44 lg:h-48 bg-card rounded-lg overflow-hidden">
 ...
 */
export const StatisticsRowSkeleton: React.FC<{ cardCount?: number }> = ({
  cardCount = 4,
}) => {
  return (
...
export const ChartSkeleton: React.FC = () => {
  return (
    <div className="w-full h-64 bg-card rounded-lg shadow-md p-6 mb-6">
      ...
      <div className="h-48 flex items-end justify-between">
        {Array.from({ length: 12 }).map((_, index) => (
          <div key={index} className="flex flex-col items-center flex-1">
            <Skeleton className="w-full bg-muted mb-2" />
...
export const TableSkeleton: React.FC<{ rows?: number; columns?: number }> = ({
  ...
  return (
    <div className="w-full bg-card rounded-lg shadow-md overflow-hidden mb-6">
      {/* Table header */}
      ...
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Estamos preparando tu dashboard con la información más reciente.
...
export const CriticalErrorSkeleton: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-destructive/5 to-warning/5 p-8">
      <div className="w-full max-w-md space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground/70">
            La aplicación no puede continuar sin estos datos. Por favor,
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="w-full bg-destructive hover:bg-destructive/90 text-destructive-foreground font-medium py-2 px-4 rounded-lg transition-colors"
          >
            Reintentar
          </button>
        )}
