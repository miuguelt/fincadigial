...
import { IconHeart, IconActivity } from "@/shared/ui/icons";
        ...
        <div className={modalStyles.twoColGrid}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              {" "}
              <IconHeart size="md" className="text-destructive" />{" "}
            ...
            <div className="flex items-center gap-4">
              ...
              {getStatusBadge((animal as any).health_status || "Saludable")}{" "}
            </div>{" "}
            <InfoField
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              {" "}
              <IconActivity size="md" className="text-info" />{" "}
              <h4 className="font-semibold text-foreground">
                Estado Reproductivo
              </h4>{" "}
            </div>{" "}
            <InfoField
              label="Etapa"
              value={(animal as any).reproductive_status || "No aplica"}
            />{" "}
            {(animal as any).sex === "Hembra" && (
              <>
                {" "}
                <InfoField
                  label="Último Parto"
