    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">4VillaLuz</h1>
          <p className="text-gray-600 mt-2">Registro de Nueva Finca</p>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className={errors['finca.name'] ? 'border-red-500' : ''}
                  />
                  {errors['finca.name'] && (
                    <p className="text-sm text-red-500 mt-1">{errors['finca.name']}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-2">
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500">Gestión comercial</div>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500">Formación SENA</div>
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={errors['owner.identification'] ? 'border-red-500' : ''}
                    />
                    {errors['owner.identification'] && (
                      <p className="text-sm text-red-500 mt-1">{errors['owner.identification']}</p>
                    )}
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      className={errors['owner.fullname'] ? 'border-red-500' : ''}
                    />
                    {errors['owner.fullname'] && (
                      <p className="text-sm text-red-500 mt-1">{errors['owner.fullname']}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={errors['owner.email'] ? 'border-red-500' : ''}
                  />
                  {errors['owner.email'] && (
                    <p className="text-sm text-red-500 mt-1">{errors['owner.email']}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={errors['owner.phone'] ? 'border-red-500' : ''}
                  />
                  {errors['owner.phone'] && (
                    <p className="text-sm text-red-500 mt-1">{errors['owner.phone']}</p>
                  )}
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className={errors['owner.password'] ? 'border-red-500' : ''}
                  />
                  {errors['owner.password'] && (
                    <p className="text-sm text-red-500 mt-1">{errors['owner.password']}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={errors['owner.confirmPassword'] ? 'border-red-500' : ''}
                  />
                  {errors['owner.confirmPassword'] && (
                    <p className="text-sm text-red-500 mt-1">{errors['owner.confirmPassword']}</p>
                  )}
                </div>
