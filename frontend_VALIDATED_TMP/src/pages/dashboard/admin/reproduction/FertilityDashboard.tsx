          ...
          <CardContent>
            <div className="space-y-4">
              {data.top_females.map((female, index) => (
                <div key={female.animal_id} className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center gap-3">
                  ...
                  <Badge className="bg-green-500">{female.rate}%</Badge>
                </div>
              ))}
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              {data.bottom_females.length > 0 ? (
                data.bottom_females.map((female, index) => (
                  <div key={female.animal_id} className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <Badge variant="outline" className="bg-red-100">#{index + 1}</Badge>
                      <div>
                        <p className="font-medium">{female.record}</p>
                        <p className="text-xs text-muted-foreground">
                          {female.inseminations} insem, {female.positive} positivas
                    ...
                    <Badge variant="destructive">{female.rate}%</Badge>
                  </div>
                ))
              ) : (
