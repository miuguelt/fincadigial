...
export default function SirePerformance() {
  ...
  const getGradeVariant = (grade: string): 'default' | 'destructive' | 'outline' | 'secondary' => {
    switch (grade) {
                ...
                {data.sires.map((sire, index) => (
                  <tr key={sire.sire_id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="p-3 text-center">
                      <span className={`font-semibold ${sire.conception_rate_pct >= 60 ? 'text-green-600' : sire.conception_rate_pct >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
                    ...
                    <td className="p-3 text-center">
                      <Badge className={getGradeColor(sire.grade)} variant={getGradeVariant(sire.grade)}>
                        {sire.grade}
                      </Badge>
                    </td>
                  </tr>
