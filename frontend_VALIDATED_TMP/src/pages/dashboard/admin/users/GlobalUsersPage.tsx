                ...
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.map((user) => (
                    <TableRow key={user.id} className="group hover:bg-green-50/30 transition-all border-b border-gray-100 last:border-0">
                      ...
                      <TableCell>
                        <Badge variant="secondary" className="bg-blue-50 text-blue-700 border-blue-100 rounded-full px-3">
                          {user.role}
                        </Badge>
                      </TableCell>
                          ...
                          {user.fincas && user.fincas.length > 0 ? (
                            user.fincas.map((f: any) => (
                              ...
                              >
                                ...
                                {f.is_active && (
                                  <div className="absolute -top-1 -right-1 h-2 w-2 bg-green-500 rounded-full border border-white" title="Activa" />
                                )}
                              </div>
                            ))
                          ) : (
                      ...
                      <TableCell>
                        <Badge 
                          ...
                          className={`rounded-full px-2 py-0 h-5 text-[10px] ${user.status ? 'bg-green-500' : 'bg-gray-400'}`}
                        >
