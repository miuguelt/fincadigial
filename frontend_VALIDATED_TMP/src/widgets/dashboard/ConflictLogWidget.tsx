...
import { AlertTriangle, CheckCircle2, History, ArrowRight, ShieldCheck } from 'lucide-react';
import { ConflictResolver, ConflictLog } from '@/shared/api/offline/ConflictResolver';
  ...
  if (logs.length === 0) {
    return (
      <div className="bg-white rounded-3xl p-6 border border-gray-50 flex flex-col items-center justify-center text-center opacity-60">
        ...
        <p className="text-[10px] text-gray-500">No se han detectado conflictos de red hoy.</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm max-h-[400px] overflow-hidden flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-bold text-gray-900">Historial de Conflictos Mesh</h3>
        </div>
            ...
            >
              ...
              <div className="grid grid-cols-[1fr,24px,1fr] items-center gap-2">
                <div className="bg-white p-2 rounded-xl border border-red-50 opacity-50 line-through">
                  <p className="text-[9px] font-bold text-gray-400">DESCARTADO</p>
                ...
                <div className="bg-green-50 p-2 rounded-xl border border-green-100">
                  <p className="text-[9px] font-bold text-green-600">PREVALECE</p>
      ...
      <button 
        onClick={() => { ConflictResolver.clearLogs(); setLogs([]); }}
