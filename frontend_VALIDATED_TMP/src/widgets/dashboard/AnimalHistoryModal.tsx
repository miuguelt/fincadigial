                 ...
                 {historyLoading ? (
                   ...
                   <div className="flex flex-col h-full">
                     <Tabs defaultValue="treatments" className="flex flex-col h-full">
                       ...
                       <TabsContent value="reproductive" className="flex-1 overflow-y-auto px-4 py-4 mt-0">
                         {(() => {
                           const reproEvents = (remoteHistory?.timeline ?? []).filter((e: any) => e.type === 'reproductive');
                           if (reproEvents.length === 0) {
                             return (
                               <div className="text-center py-12 text-muted-foreground">
                                 <p className="text-4xl mb-2">🐄</p>
                                 <p>No hay eventos reproductivos registrados para este animal.</p>
                               </div>
                             );
                           }
                           return (
                             <div className="space-y-3">
                               {reproEvents.map((e: any, idx: number) => (
                                 <div key={idx} className="flex items-start gap-3 p-3 rounded-xl border border-purple-200 bg-purple-50 dark:bg-purple-950/20">
                                   ...
                                   <div className="flex-1">
                                     ...
                                     <p className="text-xs text-text-secondary mt-0.5">{e.subtitle}</p>
                                   </div>
                                 </div>
                               ))}
                             </div>
