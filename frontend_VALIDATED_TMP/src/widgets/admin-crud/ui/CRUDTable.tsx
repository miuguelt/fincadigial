...
export function CRUDTable<T extends { id: number }>({
  ...
  return (
    <div className="relative flex-1 min-h-0 flex flex-col group/table">
      {/* Indicador visual de scroll lateral (solo visible si hay scroll) */}
      ...
      <div className={cn(
        "overflow-x-auto overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent",
