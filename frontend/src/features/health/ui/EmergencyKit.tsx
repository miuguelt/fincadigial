...
export const EmergencyKit: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-rose-50 dark:bg-stone-950 pb-20 font-sans">
      {" "}
      {/* Header de Emergencia */}{" "}
      <header className="sticky top-0 z-50 bg-rose-600 text-white p-4 shadow-[var(--shadow-token-md)]">
        {" "}
        ...
        <AnimatePresence mode="wait">
          ...
          {!selectedDisease ? (
            ...
            >
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-14 pl-12 rounded-[var(--radius-lg)] bg-card border-none shadow-md font-bold text-sm"
                />{" "}
                <IconSearch
                  size="md"
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-rose-500 transition-colors"
                />{" "}
              </div>{" "}
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                {filteredDiseases.map((disease) => (
                  <button
                    ...
                    className="flex items-center gap-4 p-5 bg-card rounded-[2rem] shadow-sm border border-border text-left hover:border-rose-500/30 transition-all active:scale-95"
                  >
                    {" "}
                    <div className="h-12 w-12 rounded-[var(--radius-lg)] bg-rose-500/10 flex items-center justify-center text-rose-600 shrink-0">
                      {" "}
              ...
              {filteredDiseases.length === 0 && !loading && (
                <div className="p-12 text-center space-y-4">
                  {" "}
                  <div className="h-16 w-16 rounded-[var(--radius-full)] bg-rose-100 mx-auto flex items-center justify-center text-rose-500">
                    {" "}
            ...
            >
              {" "}
              {/* FICHA TÉCNICA */}{" "}
              <Card className="rounded-[2.5rem] border-none shadow-[var(--shadow-token-lg)] overflow-hidden bg-card">
                {" "}
                <div className="bg-card p-8 text-white relative">
                  {" "}
                  <Badge className="bg-rose-500 text-white border-none mb-4 font-black">
                    PROTOCOLO CRÍTICO
                  </Badge>{" "}
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="p-5 bg-emerald-500/5 border border-emerald-500/20 rounded-[var(--radius-lg)] space-y-3">
                    {" "}
                  ...
                  <Button
                    className="w-full h-14 rounded-[var(--radius-lg)] bg-card text-white font-black uppercase text-[10px] tracking-widest gap-2"
              ...
              <div className="flex items-center gap-3 p-6 bg-blue-600 rounded-[2rem] text-white shadow-[var(--shadow-token-md)]">
                {" "}
