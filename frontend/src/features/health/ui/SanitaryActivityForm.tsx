  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-card min-h-screen">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-muted rounded-[2rem] border border-border shadow-sm">
          {" "}
        ...
        {/* Treatment Details */}{" "}
        <div className="bg-card p-8 rounded-[2.5rem] border-2 border-border shadow-[var(--shadow-token-lg)] shadow-slate-100/50">
          {" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              <select className="w-full bg-muted border-2 border-border rounded-[var(--radius-lg)] py-4 px-4 font-bold text-foreground outline-none focus:border-emerald-500">
                {" "}
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-muted border-2 border-border rounded-[var(--radius-lg)] py-4 px-4 font-bold text-foreground outline-none focus:border-emerald-500"
              />{" "}
            </div>{" "}
          </div>{" "}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-red-50 p-4 rounded-[var(--radius-xl)] border border-red-100">
              {" "}
              <label className="text-[10px] font-black uppercase text-red-600 mb-2 block tracking-widest">
                Tiempo de Retiro (Días)
              </label>{" "}
              <input
                type="number"
                placeholder="0"
                className="w-full bg-card border-2 border-red-200 rounded-[var(--radius-lg)] py-2 px-4 font-black text-red-700 outline-none focus:border-red-500"
              />{" "}
        ...
        <div className="flex gap-4">
          {" "}
          <button className="flex-1 bg-emerald-600 text-white p-5 rounded-[2rem] font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-[var(--shadow-token-lg)] shadow-emerald-100 hover:bg-emerald-700 transition-all active:scale-95">
            {" "}
            <IconDeviceFloppy size="lg" /> Guardar Actividad{" "}
          </button>{" "}
          <button className="bg-card text-white p-5 rounded-[2rem] font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-[var(--shadow-token-lg)] shadow-slate-200 hover:bg-black transition-all">
            {" "}
