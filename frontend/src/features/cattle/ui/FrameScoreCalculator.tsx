...
const FrameScoreCalculator: React.FC = () => {
  ...
  return (
    <div className="bg-card rounded-[2.5rem] shadow-[var(--shadow-token-lg)] shadow-slate-200/50 border border-border overflow-hidden max-w-md mx-auto">
      {" "}
      ...
      <div className="p-8 space-y-6">
        ...
        <div>
          ...
          <div className="flex bg-muted p-1 rounded-[var(--radius-lg)]">
            {" "}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Ej: 115"
              className="w-full bg-muted border-2 border-border focus:border-emerald-500 rounded-[var(--radius-lg)] py-4 pl-12 pr-4 outline-none font-bold text-foreground transition-all"
            />{" "}
          </div>{" "}
        </div>{" "}
        {/* Age Input */}{" "}
