...
export const BatchWeightModal: React.FC<BatchWeightModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      {" "}
      <DialogContent fullWidth className="!h-auto !max-h-[96dvh] p-0 overflow-hidden bg-background border border-border rounded-xl shadow-md flex flex-col transition-all duration-300 select-none">
        {" "}
        {/* 1. ELEGANT HEADER */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="bg-muted/40 border-border rounded-lg h-32 sm:h-44 pl-10 text-6xl sm:text-8xl font-bold focus:border-primary focus:bg-background focus:ring-4 focus:ring-primary/10 transition-all text-foreground placeholder:text-muted-foreground/20 tracking-tighter"
                    />{" "}
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  {" "}
                  <IconBolt size="md" /> <span>Confirmar Pesaje</span>{" "}
                </>
              )}{" "}
            </Button>{" "}
          </div>{" "}
