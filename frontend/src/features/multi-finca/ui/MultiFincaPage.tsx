    ...
    <div className="p-6 sm:p-10 space-y-10 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <Button
          ...
          className="rounded-[var(--radius-lg)] h-14 px-8 font-black uppercase text-xs tracking-widest gap-3 border-2"
        >
          {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {fincas.map((membership: any) => {
          ...
          return (
            ...
            >
              ...
              <Card
                className={cn(
                  "rounded-[2.5rem] border-4 overflow-hidden transition-all duration-500 shadow-[var(--shadow-token-lg)]",
                  isActive
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mt-8 pt-6 border-t border-border/50 flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className={cn(
                        "rounded-[var(--radius-lg)] h-12 px-6 font-black uppercase text-[10px] tracking-widest gap-2 transition-all shadow-[var(--shadow-token-md)]",
                        isActive
        ...
        {fincas.length === 0 && (
          <div className="col-span-full p-20 text-center bg-muted /50 rounded-[3rem] border-4 border-dashed border-border">
            {" "}
            <IconBuilding className="h-16 w-16 text-slate-200 mx-auto mb-4" />{" "}
            ...
            <Button
              ...
              className="mt-6 rounded-[var(--radius-lg)] bg-emerald-600"
            >
              {" "}
