...
export const DataScreenHeader: React.FC<DataScreenHeaderProps> = ({
  ...
  <div className={cn('mb-4 sm:mb-6 space-y-4 sm:space-y-5', className)}>
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-card/40 backdrop-blur-xl px-5 py-3 rounded-2xl border border-border/50 shadow-lg shadow-primary/5">
