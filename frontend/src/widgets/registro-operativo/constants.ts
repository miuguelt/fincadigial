...
export const ACTIVITY_TYPES: ActivityConfig[] = [
  { value: 'sowing', label: 'Siembra', emoji: '🌱', color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300', border: 'border-green-300 dark:border-green-700', hint: 'Semillero, siembra o resiembra' },
  { value: 'irrigation', label: 'Riego', emoji: '💧', color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300', border: 'border-blue-300 dark:border-blue-700', hint: 'Agua para el cultivo' },
  { value: 'fertilization', label: 'Fertilización', emoji: '🧪', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300', border: 'border-amber-300 dark:border-amber-700', hint: 'Abono y nutrientes' },
  { value: 'pest_control', label: 'Control Plagas', emoji: '🐛', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300', border: 'border-red-300 dark:border-red-700', hint: 'Fumigación y manejo de plagas' },
  { value: 'harvest', label: 'Cosecha', emoji: '🌾', color: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300', border: 'border-yellow-300 dark:border-yellow-700', hint: 'Levante de la producción' },
  { value: 'note', label: 'Nota/Observación', emoji: '📋', color: 'bg-gray-100 text-gray-800 dark:bg-gray-800/60 dark:text-gray-200', border: 'border-gray-300 dark:border-gray-700', hint: 'Apunte o recordatorio' },
];
