...
const Gallery: React.FC<GalleryProps> = ({ images }) => (
  <section id="galeria" className="vl-deferred-section bg-background py-8 sm:py-16 flex h-auto sm:h-auto">
    <div className="container m-auto px-2 sm:px-4">
      <h2 className="text-foreground text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Galería de Imágenes</h2>
