...
export const FieldDetailsModal: React.FC<FieldDetailsModalProps> = ({
  ...
  const getStatusColor = () => {
    if (occupationRate > 100) return getStatusBadgeClass('danger') + ' text-white';
    if (occupationRate > 80)  return getStatusBadgeClass('warning') + ' text-white';
    if (occupationRate > 50)  return getStatusBadgeClass('success') + ' text-white';
    return getStatusBadgeClass('info') + ' text-white';
  };

  const getProgressColor = () => {
    if (occupationRate > 100) return 'bg-danger-600';
