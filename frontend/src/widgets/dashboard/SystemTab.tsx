    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("dashboard.system.performance.description")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {[
              {
                label: t("dashboard.system.performance.cpu"),
                value: 45,
                color: "bg-blue-500",
              },
              {
                label: t("dashboard.system.performance.memory"),
                value: 62,
                color: "bg-green-500",
              },
              {
                label: t("dashboard.system.performance.disk"),
                value: 75,
                color: "bg-yellow-500",
              },
