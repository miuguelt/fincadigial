        ...
        <div className="lg:col-span-2 space-y-6">
          {settingsGroups.map((group) => (
            <div key={group.title} className="space-y-4">
              <h3 className="text-sm font-black uppercase tracking-widest text-muted-foreground/60 px-2">
                {group.title}
              </h3>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-none shadow-xl shadow-primary/5 bg-card/40 backdrop-blur-xl rounded-[2rem] h-fit">
            ...
            <CardContent>
              ...
              <Button
                variant="outline"
                className="w-full mt-8 rounded-2xl border-dashed border-2 hover:bg-muted/50 border-border transition-all"
              >
