          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 grid grid-cols-3 gap-4">
                <div
                  className={`text-center p-3 rounded-lg ${moduleProgress.dashboard ? "bg-green-50" : "bg-gray-50"}`}
                >
                  <Database
                    className={`w-6 h-6 mx-auto mb-1 ${moduleProgress.dashboard ? "text-green-600" : "text-gray-400"}`}
                  />
                ...
                <div
                  className={`text-center p-3 rounded-lg ${moduleProgress.animal ? "bg-green-50" : "bg-gray-50"}`}
                >
                  <PawPrint
                    className={`w-6 h-6 mx-auto mb-1 ${moduleProgress.animal ? "text-green-600" : "text-gray-400"}`}
                  />
                ...
                <div
                  className={`text-center p-3 rounded-lg ${moduleProgress.user ? "bg-green-50" : "bg-gray-50"}`}
                >
                  <Users
                    className={`w-6 h-6 mx-auto mb-1 ${moduleProgress.user ? "text-green-600" : "text-gray-400"}`}
                  />
