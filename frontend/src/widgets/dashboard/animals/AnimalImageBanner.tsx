          ...
          {selectedImage && (
            ...
            >
              ...
              {images.length > 1 && (
                <>
                        ...
                        <button
                          ...
                          className={`rounded-full transition-all duration-500 disabled:cursor-not-allowed
                            ${index === currentIndex
                              ...
                              : 'bg-card/40 hover:bg-card/60 active:bg-card/80 shadow-md w-3 sm:w-3.5 h-3 sm:h-3.5 hover:scale-110'
                            }`}
                          aria-label={`Ir a imagen ${index + 1}`}
                          aria-current={index === currentIndex ? 'true' : 'false'}
                        />
                  ...
                  <div className="absolute top-8 sm:top-10 left-8 sm:left-10 z-30">
                    <div className="bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-xl text-white px-6 py-3 sm:px-7 sm:py-3.5 rounded-lg text-base sm:text-lg font-semibold shadow-2xl border border-white/30">
              ...
              <div className="absolute bottom-28 sm:bottom-32 left-0 right-0 flex justify-center z-20 px-4 opacity-0 hover:opacity-100 transition-opacity duration-500 group-hover:opacity-100">
                <div className="bg-card/5 backdrop-blur-md text-white/70 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full text-xs sm:text-sm font-light shadow-lg border border-white/10">
