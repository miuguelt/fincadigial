    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          <Badge
            variant="outline"
            className={`text-xs font-semibold shadow-sm ${status === 'Vivo' ? 'bg-success/5/50 text-success border-success/30 dark:bg-green-950/30 dark:text-success' :
              (status as any) === 'Enfermo' ? 'bg-destructive/5/50 text-destructive border-destructive/30 dark:bg-red-950/30 dark:text-destructive/80' :
                'bg-info/5/50 text-info border-info/30 dark:bg-blue-950/30 dark:text-info/80'
              }`}
          >
            {status}
          </Badge>
          <Badge
            variant="secondary"
            className={`text-xs font-semibold shadow-sm ${gender === 'Macho' ? 'bg-info/10/50 text-info dark:bg-blue-950/30 dark:text-blue-300' :
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Información básica */}
            <div className="bg-card/40 dark:bg-card/20 rounded-xl p-5 shadow-lg border border-border/30 backdrop-blur-md">
