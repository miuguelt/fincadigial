  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <Card className="overflow-hidden border-0 bg-gradient-to-br from-sky-500 to-blue-600 text-white shadow-xl shadow-blue-500/20 rounded-[2rem]">
            <CardContent className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div className="h-12 w-12 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center">
                  <Milk className="h-6 w-6" />
                </div>
                <Badge className="bg-white/20 text-white border-0 text-[9px] font-black uppercase tracking-widest px-3 py-1">
                  Lactancia Activa
                </Badge>
              </div>
        ...
        >
          <Card className="overflow-hidden border-0 bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-xl shadow-emerald-500/20 rounded-[2rem]">
            <CardContent className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div className="h-12 w-12 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center">
      ...
      <Card className="border-white/20 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button
          onClick={generatePDF}
          className="flex-1 bg-slate-900 hover:bg-slate-800 text-white h-16 rounded-[1.5rem] font-black uppercase tracking-widest shadow-2xl"
        >
        ...
        <Button
          variant="outline"
          className="sm:w-16 h-16 rounded-[1.5rem] border-slate-200"
        >
          <ChevronRight className="h-6 w-6" />
        </Button>
      </div>

      <div className="p-6 bg-slate-100/50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-slate-200 text-[10px] text-slate-500 font-bold uppercase tracking-wider flex items-start gap-3">
