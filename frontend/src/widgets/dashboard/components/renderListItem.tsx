...
function getIcon(type: ModalType) {
  switch (type) {
    ...
    case "animal_disease":
      return <IconActivity size="sm" className="text-rose-500" />;
    case "animal_field":
      return <IconMapPin size="sm" className="text-amber-500" />;
    case "vaccination":
      return <IconSyringe size="sm" className="text-blue-500" />;
    case "treatment":
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  {item.removal_date && (
                    <Badge
                      variant="outline"
                      className="text-[9px] h-4 bg-gray-500/5 text-muted-foreground border-border"
                    >
                      {" "}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {item.weight && (
                <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30 border border-border/30">
                  {" "}
                  <div className="w-8 h-8 rounded-[var(--radius-full)] bg-blue-500/10 flex items-center justify-center">
                    {" "}
