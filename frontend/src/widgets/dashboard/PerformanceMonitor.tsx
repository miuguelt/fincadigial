...
export const PerformanceMonitor: React.FC<PerformanceMonitorProps> = ({
  ...
  const { getStats, printStats, getRedundantRequests, clear } =
    useRequestMonitor();
  ...
  const chartData = stats?.endpointStats
    ? Object.entries(stats.endpointStats).map(
        ([endpoint, data]: [string, any]) => ({
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between">
                    ...
                    <Badge
                      variant={
                        stats?.cacheHitRate > 50 ? "default" : "secondary"
                      }
                    >
                ...
                <div className="space-y-2">
                  ...
                  {stats.redundantRequests
                    ...
                    .map((req: any, index: number) => (
                      ...
                      >
                        <div className="font-mono text-[11px] fit-clamp">
                          {req.url}
                        </div>
                        <div className="text-destructive-foreground">
                          {req.count} calls in 30s
                        </div>
                      </div>
                    ))}
                </div>
