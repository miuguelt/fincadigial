      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          {(pendingOperations > 0 || syncStatus.failed > 0) && (
            <span className="absolute -top-0.5 -right-0.5 h-3.5 w-3.5 flex items-center justify-center bg-amber-500 text-white text-[8px] font-bold rounded-full">
          ...
          <div className="space-y-2 text-xs bg-muted/40 rounded-xl p-3 mb-4">
            ...
            {syncStatus.failed > 0 && (
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-red-500">{syncStatus.failed}</span>
              </div>
            )}
          </div>
        )}
