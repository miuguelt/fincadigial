      ...
      <CardContent className="p-5 h-full flex flex-col">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3
                className="font-bold text-lg leading-tight text-gray-900 truncate max-w-[150px]"
                title={user.username}
              >
                {user.username}
              </h3>
              <div className="flex items-center gap-1 mt-1">
                ...
                {!user.isActive && (
                  <Badge
                    variant="outline"
                    className="text-[10px] h-5 px-1.5 text-gray-500 bg-gray-50 border-gray-200"
                  >
                    Inactivo
                  </Badge>
                )}
        ...
        <div className="mt-auto pt-3 border-t border-gray-100 flex justify-end">
          <Button
            variant="outline"
            size="sm"
            className="w-full text-xs font-medium h-8 bg-transparent hover:bg-gray-50 border-gray-200"
            onClick={() => onView?.(user)}
          >
            Ver Perfil
          </Button>
