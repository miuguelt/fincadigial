...
import { RefreshCw, Cpu, HardDrive, Database, Wifi } from "lucide-react";
      ...
      <CardContent>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4">
            <div className="p-2 rounded border bg-slate-50/50 dark:bg-slate-900/50">
              <div className="flex justify-between text-xs mb-1">
                ...
                <span
                  className={`font-bold ${getResourceColor(health.resources.cpu)}`}
                >
              ...
              <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                <div
                  className={`h-full transition-all duration-500 ${
                    health.resources.cpu > 85
                      ? "bg-red-500"
                      : health.resources.cpu > 70
                        ? "bg-orange-500"
                        : "bg-green-500"
                  }`}
            ...
            <div className="p-2 rounded border bg-slate-50/50 dark:bg-slate-900/50">
              <div className="flex justify-between text-xs mb-1">
                ...
                <span
                  className={`font-bold ${getResourceColor(health.resources.memory)}`}
                >
              ...
              <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                <div
                  className={`h-full transition-all duration-500 ${
                    health.resources.memory > 85
                      ? "bg-red-500"
                      : health.resources.memory > 70
                        ? "bg-orange-500"
                        : "bg-green-500"
                  }`}
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
          ...
          <div className="flex items-center justify-between p-2 rounded border">
            ...
            <Badge
              variant={
                health?.environment === "development" ? "default" : "secondary"
              }
            >
              {health?.environment ?? "—"}
            </Badge>
          ...
          <div className="mt-4 p-3 rounded-lg border bg-blue-50/30 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/30">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-xs">
                ...
                <span
                  className={`font-semibold ${health.self_healing.status === "healthy" ? "text-green-600" : "text-orange-600"}`}
                >
