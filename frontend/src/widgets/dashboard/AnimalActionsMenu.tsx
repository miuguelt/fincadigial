...
export const AnimalActionsMenu: React.FC<AnimalActionsMenuProps> = ({
  ...
  const handleOpenModal = useCallback(
    (type: ModalType, mode: ModalMode, item: any = null) => {
  ...
  useEffect(() => {
    if (externalOpenModal) {
      setModalStack((prev) => {
        ...
        if (top?.type === externalOpenModal && top?.mode === externalModalMode)
          return prev;
        ...
        return [
          ...prev,
          {
            ...
            mode:
              externalModalMode === "edit"
                ? "create"
                : externalModalMode || "create",
        ...
        if (depCheck.hasDependencies) {
          ...
          const depList =
            depCheck.dependencies
              ...
              .join("\n") || "";
          const detailedMsg =
            depCheck.detailedMessage ||
            depCheck.message ||
            "Este tratamiento tiene dependencias.";
            ...
            <>
              ...
              {(error || validationErrors) && (
                <div className="rounded-xl overflow-hidden animate-in fade-in slide-in-from-top-1">
                  <div
                    className={`p-4 border-l-4 ${validationErrors ? "bg-orange-50 border-orange-500 text-orange-900 dark:bg-orange-950/30 dark:text-orange-200" : "bg-red-50 border-red-500 text-red-900 dark:bg-red-950/30 dark:text-red-200"} shadow-sm`}
                  >
            ...
            <div className="flex justify-between items-start gap-2">
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <Badge
                    variant="outline"
                    className="text-[9px] h-4 bg-amber-500/5 text-amber-600 border-amber-200"
                  >
                  ...
                  {item.removal_date && (
                    <Badge
                      variant="outline"
                      className="text-[9px] h-4 bg-gray-500/5 text-gray-500 border-gray-200"
                    >
              ...
              <Badge
                ...
                className={`text-[10px] h-5 ${!item.removal_date ? "bg-green-600 text-white animate-pulse" : ""}`}
              >
        ...
        return (
          <div className="space-y-1.5">
            <div className="flex justify-between items-center gap-2">
              ...
              <Badge
                variant="outline"
                className="text-[10px] h-5 bg-blue-500/5 text-blue-600 border-blue-200"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-start gap-3">
              <div className="flex items-center gap-2">
                <span
                  className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold ${healthConfig.bg} ${healthConfig.color} border ${healthConfig.border}`}
                >
