  ...
  return (
    <div className="bg-card rounded-xl p-6 border border-border/50 shadow-sm max-h-[400px] overflow-hidden flex flex-col">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="bg-warning/5 text-warning px-2 py-1 rounded-full text-[11px] font-black uppercase">
          Auto-Resueltos
        </span>
      </div>
          ...
          {logs.map((log) => (
            ...
            >
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-black text-muted-foreground uppercase fit-clamp max-w-[150px]">
      ...
      <button
        ...
        className="mt-4 text-[11px] font-bold text-muted-foreground hover:text-destructive transition-colors uppercase text-center"
      >
