...
export const TreeHelpTooltip: React.FC<TreeHelpTooltipProps> = ({
  type,
  className,
}) => {
  ...
  const helpContent =
    type === "ancestors"
      ? {
          ...
          description:
            "Muestra la línea genealógica ascendente del animal (padres, abuelos, bisabuelos...).",
          requirements: [
      ...
      : {
          ...
          description:
            "Muestra la línea genealógica descendente del animal (hijos, nietos, bisnietos...).",
          requirements: [
