...
export const GrowthAnomalyMonitor: React.FC = () => {
  ...
  return (
    <Card className="rounded-[2rem] border-0 bg-card/80 backdrop-blur-md shadow-[var(--shadow-token-lg)] overflow-hidden group">
      {" "}
      ...
      <CardContent className="p-0">
          ...
          {isLoading ? (
            ...
            <AnimatePresence>
              ...
              {anomalies.map((anomaly, idx) => (
                ...
                >
                  {" "}
                  <div className="p-2 rounded-[var(--radius-lg)] bg-muted group-hover:bg-card transition-colors shadow-sm">
                    {" "}
        ...
        <div className="p-4 bg-muted/50 border-t border-border">
          {" "}
          <button className="w-full py-2 text-xs font-black uppercase tracking-widest text-primary hover:text-primary/80 transition-colors">
            {" "}
