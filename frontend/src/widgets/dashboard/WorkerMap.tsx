    ...
    <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm flex flex-col h-[600px]">
      ...
      <div className="flex-1 relative bg-slate-50 overflow-hidden">
        ...
        <svg viewBox="0 0 100 100" className="w-full h-full preserve-3d">
          ...
          <path
            d="M10,20 L40,15 L45,40 L15,45 Z"
            fill="#ecfdf5"
            stroke="#10b981"
            strokeWidth="0.2"
          />
          <path
            d="M45,15 L80,10 L85,35 L50,40 Z"
            fill="#f0fdf4"
            stroke="#22c55e"
            strokeWidth="0.2"
          />
          <path
            d="M15,50 L45,45 L40,80 L10,75 Z"
            fill="#f0fdf4"
            stroke="#22c55e"
            strokeWidth="0.2"
          />
          <path
            d="M50,45 L90,40 L85,85 L55,80 Z"
            fill="#ecfdf5"
            stroke="#10b981"
            strokeWidth="0.2"
          />
              ...
              >
                ...
                >
                  <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-lg p-1.5 shadow-xl">
                    <p className="text-[8px] font-bold text-gray-900 leading-none whitespace-nowrap">
