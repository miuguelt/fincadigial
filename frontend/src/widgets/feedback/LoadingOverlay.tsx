...
export function LoadingOverlay({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col items-center gap-4 px-8 py-6 rounded-lg shadow-xl border transform transition-all duration-300 ease-out animate-scale-in bg-surface ${
