...
import type { WeatherDashboard, WeatherAlert, WeatherForecast, WeatherRecord, WeatherUpdateResult } from '../model/types';
...
export const weatherService = {
  ...
  getCurrent: async (fincaId: number): Promise<{ record: WeatherRecord | null; alerts_generated: number; forecast: WeatherForecast }> => {
