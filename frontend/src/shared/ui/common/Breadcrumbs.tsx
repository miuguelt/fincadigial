...
const routeConfig: Record<string, string> = {
  ...
  'growth': 'Crecimiento',
  'animal-fields': 'Historial de Pastoreo',
  'animalFields': 'Historial de Pastoreo',

  // Sanidad Animal
  'health': 'Sanidad Animal',
  'disease-animals': 'Enfermedades y Alertas',
  'animalDiseases': 'Enfermedades y Alertas',
  'diseases': 'Enfermedades',
  'treatments': 'Tratamientos e Insumos',
  'treatment_medications': 'Medicamentos de Tratamiento',
  'treatment-medications': 'Medicamentos de Tratamiento',
  'treatment_vaccines': 'Vacunas de Tratamiento',
  'treatment-vaccines': 'Vacunas de Tratamiento',
  'treatment-protocols': 'Protocolos de Tratamiento',
  'treatmentProtocols': 'Protocolos de Tratamiento',
  'treatment_recommendations': 'Recomendaciones Veterinarias',
  'treatment-recommendations': 'Recomendaciones Veterinarias',
  'vaccinations': 'Vacunaciones',
  'vaccines': 'Vacunas',
  'medications': 'Medicamentos',
  'route_administration': 'Vías de Administración',
  'route-administration': 'Vías de Administración',
