...
export const ROLE_PERMISSIONS: Record<string, '*' | EntityPermissions> = {
  ...
  Capataz: {
    ...
    'treatment-protocols': READ_CREATE_UPDATE,
    'treatment-protocol-insumos': READ_CREATE,
  ...
  Veterinario: {
    ...
    'treatment-protocols': READ_CREATE_UPDATE,
    'treatment-protocol-insumos': READ_CREATE_UPDATE,
  ...
  Instructor: {
    ...
    'treatment-recommendations': READ_CREATE,
    'treatment-vaccines': READ_CREATE,
    'treatment-protocols': READ_CREATE,
    'treatment-protocol-insumos': READ_CREATE,
    'treatments': READ_CREATE,
    'vaccinations': READ_CREATE,
    'vaccines': NONE,
  ...
  Operario: {
    ...
    'treatment-protocols': READ,
    'treatment-protocol-insumos': READ,
    'treatments': READ,
    'vaccinations': READ,
    'vaccines': READ,
  },
...
const ENTITY_ALIASES: Record<string, string> = {
  ...
  'protocolo de tratamiento': 'treatment-protocols',
  'insumo de protocolo': 'treatment-protocol-insumos',
