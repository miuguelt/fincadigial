...
import { AppProviders } from "../integration/testHelpers";
...
describe("Módulo de Acciones Masivas y Reportes", () => {
  ...
  describe("BatchReproductionModal", () => {
    ...
    it("muestra campos dinámicos para Inseminación y permite enviar la solicitud", async () => {
      ...
      // El segundo combobox es el de Toro / Padre
      const selectSire = comboboxes[1];
  ...
  describe("animalReportService", () => {
    ...
    it("generar reporte PDF sin errores", async () => {
    ...
    it("generar reporte CSV sin errores", () => {
