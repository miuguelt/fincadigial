      ...
      <Card className="w-full max-w-md h-fit my-auto">
        <CardContent className="pt-8">
          <div className="text-center">
            <div className="mx-auto flex items-center justify-center w-12 h-12 rounded-[var(--radius-full)] bg-green-100 mb-4">
              <IconUserPlus size="md" className="text-green-600" />
            </div>
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
              <IconLoader2 size="sm" className="animate-spin text-green-600" />
