    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <IconUser size="sm" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
          <Input
            id="name"
            name="name"
            type="text"
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <IconMail size="sm" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
          <Input
            id="email"
            name="email"
            type="email"
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <IconPhone size="sm" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
          <Input
            id="phone"
            name="phone"
            type="tel"
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <IconLock size="sm" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
          <Input
            id="password"
            name="password"
      ...
      <Button
        ...
        className="w-full py-2 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg disabled:opacity-60 gap-2"
      >
        {loading ? (
          <>
