...
const formSections: CRUDFormSection<ProtocolForm>[] = [
  {
    ...
    gridCols: 2,
    fields: [
      { name: 'name', label: 'Nombre del protocolo', type: 'text', required: true, placeholder: 'Ej: Mastitis aguda - terapia intramamaria' },
      ...
      { name: 'description', label: 'Descripción y pasos', type: 'textarea', required: true, placeholder: 'Explique cómo se aplica, precauciones y cuándo consultar…', colSpan: 2 },
      { name: 'default_dosis', label: 'Dosis por defecto', type: 'text', placeholder: 'Ej: 10 ml por cuarto afectado' },
      { name: 'default_frequency', label: 'Frecuencia por defecto', type: 'text', placeholder: 'Ej: Cada 12 h por 5 días' },
      { name: 'withdrawal_days', label: 'Días de retiro', type: 'number', placeholder: '0' },
      { name: 'duration_days', label: 'Duración (días)', type: 'number', placeholder: 'Opcional' },
    ],
  },
];
