...
export type AnimalCrudOverrides = Pick<AnimalCrudConfig, 'viewMode' | 'columns' | 'formSections' | 'batchActions' | 'renderCard' | 'cardGridClassName' | 'defaultLimit' | 'defaultFields' | 'customToolbar' | 'toolbarPlacement' | 'expandableSearch' | 'customActions' | 'preDeleteCheck' | 'onAfterCreate' | 'onAfterUpdate'>;
