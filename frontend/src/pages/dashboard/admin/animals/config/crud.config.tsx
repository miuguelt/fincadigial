...
export type AnimalCrudOverrides = Pick<AnimalCrudConfig, 'viewMode' | 'columns' | 'formSections' | 'batchActions' | 'renderCard' | 'cardGridClassName' | 'defaultLimit' | 'defaultFields' | 'customToolbar' | 'customActions' | 'preDeleteCheck' | 'onAfterCreate' | 'onAfterUpdate'>;
