  ...
  return [
    {
      ...
      fields: [
        ...
        { name: 'severity' as any, label: '¿Qué tan grave está?', type: 'select' as CRUDFieldType, options: ANIMAL_DISEASE_SEVERITIES as any, placeholder: 'Seleccione la gravedad' },
        {
          ...
          placeholder: 'Escriba aquí si la res tiene fiebre, no come, o qué medicamentos se le están dando...',
          colSpan: 2,
          helperText: 'Toca una observación frecuente o describe el cuadro clínico',
          suggestions: [
            'Fiebre alta, decaimiento y aislamiento del lote',
            'Ubre inflamada, caliente y leche con grumos',
            'Cojera evidente con inflamación en casco',
            'Diarrea profusa y deshidratación leve',
            'Herida abierta con presencia de miasis (gusanera)',
            'Pérdida de apetito y baja súbita en producción de leche',
          ],
        },
      ],
    },
