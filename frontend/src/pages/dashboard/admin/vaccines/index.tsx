      ...
      fields: [
        {
          ...
          colSpan: 2,
          suggestions: [
            'Fiebre Aftosa (Aftogan)',
            'Brucelosis B19 / RB51',
            'Carbunco Sintomático (Mancha)',
            'Rabia Paresiante',
            'Complejo Reproductivo (IBR/DVB)',
            'Clostridiosis (8 vías)',
            'Triple Bovina',
          ],
        },
        { name: 'type', label: 'Tipo', type: 'select', options: VACCINE_TYPES as any, placeholder: 'Seleccionar tipo' },
        {
          ...
          type: 'text',
          placeholder: 'Ej: 2 mL',
          suggestions: ['2 mL', '3 mL', '5 mL', '10 mL', '2 cc', '5 cc'],
        },
        ...
        {
          name: 'vaccination_interval' as any,
          label: 'Intervalo de Vacunación (días)',
          type: 'number',
          placeholder: 'Ej: 180',
          suggestions: [
            { label: 'Semestral (180 días)', value: 180 },
            { label: 'Anual (365 días)', value: 365 },
            { label: 'Dosis única (0)', value: 0 },
            { label: 'Refuerzo (21 días)', value: 21 },
            { label: 'Refuerzo (30 días)', value: 30 },
          ],
        },
