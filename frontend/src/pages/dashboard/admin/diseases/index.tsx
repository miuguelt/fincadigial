    ...
    fields: [
      {
        ...
        suggestions: [
          ...
          'Anaplasmosis / Babesiosis (Tristeza)',
          'Timpanismo / Meteorismo',
          'Pododermatitis (Gabarro / Casco)',
          'Neumonía / Complejo Respiratorio',
      ...
      },
      {
        ...
        suggestions: [
          'Fiebre alta, depresión y pérdida de apetito',
          'Ubre inflamada, dura y leche con grumos o sangre',
          'Cojera severa con dolor e inflamación interdigital',
          'Diarrea acuosa abundante y deshidratación',
          'Dificultad respiratoria, tos y secreción mucopurulenta',
        ],
      },
      {
        name: 'details',
        label: 'Detalles',
        type: 'textarea',
        placeholder: 'Detalles y descripción general...',
        colSpan: 2,
        suggestions: [
          'Enfermedad infecciosa de declaración oficial ante el ICA',
          'Afecta vacas en producción; requiere aislamiento preventivo',
          'Enfermedad parasitaria transmitida por garrapatas',
          'Tratamiento antibiótico inmediato y desinfección del área',
        ],
      },
    ],
  },
