...
export function ReproductionSection({ form }: ReproductionSectionProps) {
	...
	return (
		<section
			className="rounded-xl border border-purple-200 bg-purple-50/60 p-4 shadow-sm sm:p-5 dark:border-purple-800 dark:bg-purple-950/30"
		...
		>
			<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
				<div>
					<h3
						...
						className="text-xl font-bold text-purple-950 dark:text-purple-100"
					>
				...
				<Button
					...
					className={`min-h-12 w-full sm:w-auto ${
						form.showRepro
							...
							: "border-purple-300 bg-card text-purple-800 dark:border-purple-700 dark:text-purple-300"
					}`}
				>
			...
			{form.showRepro && (
				<fieldset id="corral-reproduction-options" className="mt-4">
					<legend className="mb-3 font-semibold text-purple-950 dark:text-purple-100">
						¿Qué ocurrió?
					</legend>
							...
							return (
								<button
									...
									className={`min-h-24 rounded-xl border-2 p-3 text-center transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-purple-500/40 active:scale-[0.98] ${
										selected
											? "border-purple-600 bg-purple-100 font-bold text-purple-950 ring-2 ring-purple-500 ring-offset-2 ring-offset-background dark:bg-purple-950/60 dark:text-purple-100"
											: "border-purple-200 bg-card text-foreground hover:bg-purple-50 dark:border-purple-800 dark:hover:bg-purple-950/40"
									}`}
								>
