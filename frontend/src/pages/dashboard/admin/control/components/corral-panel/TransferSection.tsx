...
export function TransferSection({
	...
	return (
		<section
			className="rounded-xl border border-orange-200 bg-orange-50/60 p-4 shadow-sm sm:p-5"
			...
			<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
				<div>
					<h3
						...
						className="text-xl font-bold text-orange-950"
					>
						<span aria-hidden="true">{step}. 🌱</span> ¿Lo va a pasar a otro
						potrero?
					</h3>
					<p className="mt-1 text-sm text-orange-900">Este paso es opcional.</p>
				</div>
				<Button
					type="button"
				...
				<div id="corral-transfer-fields" className="mt-4 space-y-2">
					...
					>
						<SelectTrigger
							...
							className="h-14 w-full border-orange-300 bg-white text-base sm:text-lg"
						>
							<SelectValue
								placeholder={
									loadingFields
					...
					<p id="corral-target-field-help" className="text-sm text-gray-600">
