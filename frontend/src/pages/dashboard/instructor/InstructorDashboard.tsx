      ...
      <div className="w-full max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-indigo-200/50 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-indigo-600/70 ml-auto">4 cursos disponibles</span>
          </div>
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-indigo-200">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-white rounded-lg border border-indigo-200/50 hover:border-indigo-300 transition-all min-w-fit group"
            >
              <BookOpen className="h-4 w-4 text-indigo-500 group-hover:text-indigo-600" />
              <div className="text-left">
                <p className="text-xs font-medium text-gray-900">Manejo Básico</p>
                <p className="text-[10px] text-gray-500">8 lecciones • 2h</p>
              </div>
            </button>
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-white rounded-lg border border-indigo-200/50 hover:border-indigo-300 transition-all min-w-fit group"
            >
              <Heart className="h-4 w-4 text-rose-500 group-hover:text-rose-600" />
              <div className="text-left">
                <p className="text-xs font-medium text-gray-900">Sanidad Animal</p>
                <p className="text-[10px] text-gray-500">12 lecciones • 4h</p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs font-medium text-gray-900">Reproducción</p>
                <p className="text-[10px] text-gray-500">6 lecciones • 2.5h</p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs font-medium text-gray-900">Registro ICA</p>
                <p className="text-[10px] text-gray-500">10 lecciones • 3h</p>
              </div>
            </button>
          </div>
        </div>
