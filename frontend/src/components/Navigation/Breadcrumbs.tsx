...
const routeMap: Record<string, string> = {
  ...
  '/admin/reproduction/kpis': 'Indicadores del Ganado',
  ...
  '/admin/treatment-protocols': 'Protocolos de Tratamiento',
  '/admin/treatment_recommendations': 'Recomendaciones Veterinarias',
  '/admin/treatment_medications': 'Medicamentos de Tratamiento',
  '/admin/treatment_vaccines': 'Vacunas de Tratamiento',
  '/admin/plans': 'Planes de Manejo',
  '/admin/route_administration': 'Vías de Administración',
  '/admin/animal-fields': 'Historial de Pastoreo',
  '/admin/financial': 'Finanzas y Balance',
  '/admin/food-types': 'Alimentación y Forrajes',
  '/admin/breeds': 'Razas',
  '/admin/species': 'Especies',
  '/admin/disease-animals': 'Enfermedades y Alertas',
  '/admin/diseases': 'Enfermedades',
  '/admin/vaccines': 'Vacunas',
  '/admin/medications': 'Medicamentos',
  '/admin/milk-production': 'Producción de Leche',
