...
# Login — credentials come from the environment, never from this file.
debug_email = os.environ.get("DEBUG_LOGIN_EMAIL")
debug_password = os.environ.get("DEBUG_LOGIN_PASSWORD")
if not debug_email or not debug_password:
    sys.exit(
        "Faltan credenciales. Exporta DEBUG_LOGIN_EMAIL y DEBUG_LOGIN_PASSWORD "
        "antes de ejecutar este script de depuracion."
    )
