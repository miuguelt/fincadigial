...
class ProductionConfig(Config):
    ...
    # Ajustar el pool de PostgreSQL según límites del servidor
    SQLALCHEMY_ENGINE_OPTIONS = {
        'pool_size': int(os.getenv('DB_POOL_SIZE', '50')), # Aumentado para producción real
        'max_overflow': int(os.getenv('DB_MAX_OVERFLOW', '100')),
        'pool_timeout': 45,
        'pool_recycle': 900, # Reciclar más rápido en producción para evitar leaks del SO
        'pool_pre_ping': True
    }
