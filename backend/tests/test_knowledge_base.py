...
def ctx_vaca_dias_abiertos(dias: int) -> dict:
    return {
        'age_in_days': 1200, 'age_in_months': 40, 'weight': 480.0,
        'is_pregnant': False, 'is_lactating': True,
        'sexo': 'Hembra', 'status': 'Vivo',
        'dias_desde_parto': dias, 'dias_abiertos': dias,
        'dias_desde_control': 30, 'ultimo_peso_control': 480.0,
        'pending_alerts_count': 0, 'leche_promedio_7d': 8.0,
    }


def ctx_ternero(edad_dias: int, peso: float) -> dict:
    return {
        'age_in_days': edad_dias, 'age_in_months': edad_dias // 30,
        'weight': peso, 'is_pregnant': False, 'is_lactating': False,
        'sexo': 'Macho', 'status': 'Vivo',
        'dias_desde_parto': None, 'dias_abiertos': 0,
        'dias_desde_control': 100, 'ultimo_peso_control': peso,
        'pending_alerts_count': 0, 'leche_promedio_7d': None,
    }
