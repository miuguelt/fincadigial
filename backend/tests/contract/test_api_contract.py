...
ANIMAL_SCHEMA = {
    ...
    "properties": {
        ...
        "especie":          {"type": "string", "enum": ["bovino","porcino","equino","caprino"]},
...
CONTROL_SCHEMA = {
    "type": "object",
    "required": ["id", "animal_id", "fecha", "tipo", "diagnostico", "observaciones", "created_at"],
    "properties": {
        "id":            {"type": "integer"},
        "animal_id":     {"type": "integer"},
        "fecha":         {"type": "string", "format": "date"},
        "tipo":          {"type": "string", "enum": ["preventivo", "curativo", "rutina", "Sano"]}, # Handle backend enum mapping
...
REPORTE_ICA_SCHEMA = {
    "type": "object",
    "required": ["finca_id", "finca_nombre", "departamento", "municipio", "propietario", "fecha_generacion", "animales"],
    "properties": {
        ...
        "animales": {
            ...
            "items": {
                "type": "object",
                "required": ["arete", "especie", "raza", "sexo", "edad_meses", "peso_kg", "estado"],
                "properties": {
                    "arete":      {"type": "string", "pattern": "^COL-\\d{3}-\\d{4}$"},
                    "especie":    {"type": "string", "enum": ["bovino","porcino","equino","caprino"]},
                    "raza":       {"type": "string"},
