...
class TestRegulatoryReports(unittest.TestCase):
    ...
    def test_inventory_report_finca_educativa_blocked(self):
        """Reporte bloqueado para finca educativa."""
        ...
        self.assertIn('solo aplican a fincas tradicionales', data.get('message', ''))
