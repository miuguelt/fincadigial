...
def serialize_animal(animal):
    ...
    return {
        ...
        "created_at": animal.created_at.isoformat() + "Z" if animal.created_at else datetime.now(timezone.utc).replace(tzinfo=None).isoformat() + "Z"
    }
...
def serialize_potrero(field):
    return {
        ...
        "estado": "activo",
        "created_at": field.created_at.isoformat() + "Z" if field.created_at else datetime.now(timezone.utc).replace(tzinfo=None).isoformat() + "Z"
    }
...
def serialize_control(ctrl):
    ...
    return {
        ...
        "created_at": ctrl.created_at.isoformat() + "Z" if ctrl.created_at else datetime.now(timezone.utc).replace(tzinfo=None).isoformat() + "Z"
    }
...
def get_reporte_ica():
    ...
    return jsonify({
        ...
        "fecha_generacion": datetime.now(timezone.utc).replace(tzinfo=None).isoformat() + "Z",
