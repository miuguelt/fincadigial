...
class APIResponse:
    ...
    @staticmethod
    def not_found(resource: str = "Recurso", details: Optional[Dict] = None) -> tuple:
        """
    ...
    @staticmethod
    def unauthorized(message: str = "Acceso no autorizado", details: Optional[Dict] = None) -> tuple:
        """
    ...
    @staticmethod
    def forbidden(message: str = "Acceso prohibido", details: Optional[Dict] = None) -> tuple:
        """
