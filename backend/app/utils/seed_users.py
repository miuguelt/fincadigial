...
def ensure_test_users():
    ...
    try:
        ...
        target_creds = [
            ...
            {"id": int(os.getenv('TEST_USER_VETERINARIO_ID', '66666666')), "email": "veterinario@villaluz.co", "name": "Doc. Veterinario", "role": Role.Veterinario, "pwd": admin_password},
            {"id": int(os.getenv('TEST_USER_OPERARIO_ID', '55555555')), "email": "operario@villaluz.co", "name": "Juan Operario", "role": Role.Operario, "pwd": admin_password}
        ]
