...
from app.utils.rbac import require_permission, has_permission
...
from app.utils.cache_helpers import (
    LRUCache, MAX_CACHE_ENTRIES_PER_MODEL, MAX_TOTAL_CACHE_SIZE_MB,
    _LIST_CACHE, _DETAIL_CACHE,
    _get_cache_key_with_user, _get_cache_ttl,
        ...
        class ModelBulkResource(Resource):
            ...
            def post(self):
                try:
                    ...
                    return APIResponse.error('Error interno del servidor', details={'error': str(e)})
