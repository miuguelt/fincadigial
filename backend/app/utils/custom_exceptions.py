...
class BusinessRuleException(Exception):
    ...
    def __init__(self, message, status_code=400, error_code="BUSINESS_RULE_VIOLATION", details=None):
...
class ResourceNotFoundException(Exception):
    ...
    def __init__(self, message="Recurso no encontrado", resource_name=None, resource_id=None):
        super().__init__(message)
        self.message = message
