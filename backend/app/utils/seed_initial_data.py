...
# Configurar path para importar app (asumiendo que estamos en BackFinca/app/utils/)
...
def seed():
    ...
    with app.app_context():
        ...
        print(f"✅ Especies sincronizadas")
        ...
        for d in diseases_data:
            if not Diseases.query.filter_by(name=d["name"]).first():
                Diseases.create(**d)
        print(f"✅ Enfermedades sincronizadas")
        ...
        print(f"✅ Rutas de administración sincronizadas")
        ...
        print(f"✅ Alimentos sincronizados")
        ...
        print(f"✅ Potreros sincronizados")
