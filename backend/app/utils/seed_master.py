...
def seed_learning_materials():
    ...
    velez = Territory.query.filter_by(municipality="Vélez").first()
    mats = [
        {"title": "Manual de Buenas Prácticas Ganaderas (BPG)", "category": "Sanidad Animal", "uri": "/mock/bpg.pdf"},
        {"title": "Guía de Bienestar Animal ICA", "category": "Sanidad Animal", "uri": "/mock/bienestar.pdf"},
    ]
    for m in mats:
