...
finca_summary_model = multi_finca_ns.model(
    "FincaSummary",
    {
...
switch_finca_model = multi_finca_ns.model(
    "SwitchFincaRequest",
    {
        "finca_id": fields.Integer(
            required=True, description="ID de la finca a activar"
        ),
    },
)

current_finca_model = multi_finca_ns.model(
    "CurrentFincaResponse",
    {
...
switch_response_model = multi_finca_ns.model(
    "SwitchFincaResponse",
    {
        "message": fields.String(description="Mensaje de éxito"),
        "finca": fields.Nested(
            finca_summary_model, description="Datos de la finca activada"
        ),
    ...
    def get(self):
        ...
        try:
            ...
            return APIResponse.error(
                "Error al obtener fincas", details={"error": str(e)}, status_code=500
            )
...
class CurrentFincaResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            if not active_finca:
                return APIResponse.error("No tiene finca asignada", status_code=404)
...
class SwitchFincaResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            if not target_finca:
                return APIResponse.error(
                    "Finca no encontrada", status_code=404, error_code="FINCA_NOT_FOUND"
                )
            ...
            if not success:
                return APIResponse.error(
                    "No se pudo cambiar la finca activa", status_code=500
                )
            ...
            user_claims = {
                ...
                "finca_type": target_finca.type.value
                if target_finca.type
                else "Educativa",
            }
            ...
            return APIResponse.error(
                "Error al cambiar de finca", details={"error": str(e)}, status_code=500
            )
...
class CheckAccessResource(Resource):
    ...
    def get(self, finca_id: int):
        ...
        try:
            ...
            return APIResponse.error(
                "Error al verificar acceso", details={"error": str(e)}, status_code=500
            )
...
class CreateFincaResource(Resource):
    ...
    create_finca_model = multi_finca_ns.model(
        "CreateFincaRequest",
        {
            "name": fields.String(
                required=True,
                description="Nombre de la finca",
                example="Mi Nueva Finca",
            ),
            "type": fields.String(
                required=True,
                description="Tipo: Educativa o Tradicional",
                example="Tradicional",
            ),
            "nit": fields.String(
                required=False, description="NIT de la finca", example="123456789-0"
            ),
            "department": fields.String(
                required=False, description="Departamento", example="Santander"
            ),
            "municipality": fields.String(
                required=False, description="Municipio", example="Bucaramanga"
            ),
            "address": fields.String(
                required=False, description="Dirección", example="Vereda El Carmen"
            ),
        },
    )

    create_finca_response = multi_finca_ns.model(
        "CreateFincaResponse",
        {
    ...
    def post(self):
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    "Error al sembrar configs para finca %s: %s", finca.id, e
                )
            ...
            return APIResponse.error(
                "Error al crear la finca", details={"error": str(e)}, status_code=500
            )
...
class InviteUserResource(Resource):
    ...
    invite_model = multi_finca_ns.model(
        "InviteUserRequest",
        {
            "user_id": fields.Integer(
                required=False, description="ID del usuario a invitar"
            ),
            "email": fields.String(
                required=False, description="Email del usuario a invitar"
            ),
            "finca_id": fields.Integer(required=True, description="ID de la finca"),
            "role": fields.String(
                required=True, description="Rol a asignar en la finca"
            ),
        },
    )
    ...
    def post(self):
        ...
        try:
            ...
            role_in_target = UserFinca.get_role_in_finca(
                current_user_id, target_finca_id
            )
            if not role_in_target:
                return APIResponse.error(
                    "No tiene acceso a esta finca", status_code=403
                )
            ...
            return APIResponse.error(
                "Error al invitar usuario", details={"error": str(e)}, status_code=500
            )
...
class CompareKPIsResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return APIResponse.error(
                "Error al comparar KPIs", details={"error": str(e)}, status_code=500
            )
