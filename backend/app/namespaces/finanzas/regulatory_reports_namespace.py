...
from app.models import (
    Animal, Animals, Finca, User, Role, UserFinca,
    Vaccination, Vaccinations, Treatment, Treatments,
    Control, AnimalField, AnimalFields
)
from app import db
        ...
        try:
            ...
            if format_type == 'pdf':
                ...
                pdf_content = pdf_report_service.generate_inventory_pdf(
                    finca.name, finca_info, inventory_data
                )
                return Response(
                    pdf_content,
        ...
        try:
            ...
            if format_type == 'pdf':
                ...
                pdf_content = pdf_report_service.generate_movements_pdf(
                    finca.name, finca_info, movements_data
                )
                return Response(
                    pdf_content,
                    mimetype='application/pdf',
        ...
        try:
            ...
            if health_type in ['vaccinations', 'all']:
                ...
                for vacc in vaccinations:
                    health_data.append({
                        ...
                        'dosis': '2ml', # Dosis estándar o extraer de Vaccines si existe
                        'via_administracion': vacc.route_name or 'N/A',
                        'registro_ica': 'REG-ICA-V-' + str(vacc.id), # Generar un ID de registro para el reporte
                        'lote': 'L-2024-X', # Marcador
                        'veterinario': 'MVZ General',
                        'observaciones': 'Plan Sanitario Nacional: ' + (vacc.national_plan or 'N/A')
                    })
            ...
            if health_type in ['treatments', 'all']:
                ...
                for treat in treatments:
                    ...
                    if treat.animal and treat.animal.record:
                        animal_record = treat.animal.record
                    ...
                    health_data.append({
                        ...
                        'lote': '',
                        'veterinario': 'MVZ General',
                        'observaciones': treat.observations or ''
                    })
            ...
            if health_type in ['controls', 'all']:
                ...
                for ctrl in controls:
                    animal_record = 'SIN_ARETE'
                    if ctrl.animal and ctrl.animal.record:
                        animal_record = ctrl.animal.record
                    ...
                    health_data.append({
                        ...
                        'registro_ica': '',
                        'lote': '',
                        'veterinario': ctrl.veterinarian or '',
                        'observaciones': ctrl.observations or ''
                    })
            ...
            if format_type == 'pdf':
                ...
                pdf_content = pdf_report_service.generate_health_pdf(
                    finca.name, finca_info, health_data
                )
                return Response(
                    pdf_content,
                    mimetype='application/pdf',
