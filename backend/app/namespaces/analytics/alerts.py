...
class SystemAlerts(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            _PRIORITY_UI = priority_ui_entry.extra if (priority_ui_entry and priority_ui_entry.extra) else {}
            _ICON_MAP = _PRIORITY_UI.get('icons', {'CRITICAL': '🚨', 'HIGH': '🚨', 'MEDIUM': '⚠️', 'LOW': 'ℹ️'})
            _COLOR_MAP = _PRIORITY_UI.get('colors', {'CRITICAL': 'red', 'HIGH': 'red', 'MEDIUM': 'orange', 'LOW': 'blue'})
