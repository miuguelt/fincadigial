...
predictions_ns = Namespace(
    "analytics/predictions", description="🔮 Analytics - Predicciones de crecimiento"
)
...
class AnimalWeightPrediction(Resource):
    @predictions_ns.doc(
        ...
        params={
            "date": {"description": "Fecha objetivo (YYYY-MM-DD)", "type": "string"}
        },
        security=["Bearer", "Cookie"],
        responses={
            200: "Predicción de peso",
            400: "Fecha inválida",
            401: "No autorizado",
        },
    )
    ...
    def get(self, animal_id):
        ...
        try:
            ...
            return APIResponse.error(
                "Formato de fecha inválido (YYYY-MM-DD)", status_code=400
            )
