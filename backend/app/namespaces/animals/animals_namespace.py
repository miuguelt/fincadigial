        ...
        try:
            ...
            if not animal_id:
                return APIResponse.error(
                    message="Parámetro animal_id es requerido", status_code=400
                )
            ...
            tree = build_ancestor_tree(
                root_id=animal_id, max_depth=max_depth, fields=fields
            )

            return APIResponse.success(
                data=tree, message="Árbol de ancestros generado exitosamente"
            )
        except Exception as e:
            return APIResponse.error(
                message=f"Error al generar árbol de ancestros: {str(e)}"
            )
...
class AnimalDescendantsTree(Resource):
    ...
    def get(self):
        try:
            ...
            return APIResponse.success(
                data=tree, message="Árbol de descendientes generado exitosamente"
            )
        except Exception as e:
            return APIResponse.error(
                message=f"Error al generar árbol de descendientes: {str(e)}"
            )
...
class AnimalStatus(Resource):
    ...
    def get(self):
        try:
            ...
            return APIResponse.success(
                data={"total": total, "activos": activos, "inactivos": inactivos}
            )
        except Exception as e:
...
class AnimalBatchVaccinate(Resource):
    ...
    def post(self):
        try:
            ...
            if not vaccine_id:
                return APIResponse.validation_error(
                    {"vaccine_id": "Se requiere ID de vacuna"}
                )
