...
medications_ns = create_optimized_namespace(
    "medications", "💊 Gestión de Medicamentos", Medications
)

# Enhanced model definitions for Swagger documentation
medication_model = medications_ns.model(
    "Medication",
    {
        ...
        "name": fields.String(
            ...
            example="Antibiótico XYZ",
        ),
        "description": fields.String(
            required=True, description="Descripción del medicamento"
        ),
        "indications": fields.String(
            required=True, description="Indicaciones del medicamento"
        ),
        "contraindications": fields.String(
            description="Contraindicaciones del medicamento"
        ),
        "route_administration_id": fields.Integer(
            required=True, description="ID de la ruta de administración"
        ),
        "availability": fields.Boolean(
            description="Disponibilidad del medicamento", default=True
        ),
        ...
        "route_administration_rel": fields.Nested(
            medications_ns.model(
                "RouteAdminRef",
                {
...
medication_input_model = medications_ns.model(
    "MedicationInput",
    {
        "name": fields.String(
            required=True,
