...
finca_model = public_ns.model('FincaInput', {
    ...
    'department': fields.String(required=False, description='Departamento', example='Antioquia'),
    'municipality': fields.String(required=False, description='Municipio', example='Medellín'),
