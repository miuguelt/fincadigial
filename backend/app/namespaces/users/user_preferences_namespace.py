...
favorites_list_model = prefs_ns.model(
    "FavoritesList",
    {
...
class UserFavorites(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            favorites = (
                UserFavorite.query.filter_by(user_id=user_id)
            ...
            return APIResponse.error(
                message="Error al obtener favoritos", status_code=500
            )
    ...
    def post(self):
        ...
        try:
            ...
            if not data.get("endpoint"):
                return APIResponse.error(
                    message="El campo endpoint es requerido", status_code=400
                )
            ...
            if existing:
                return APIResponse.success(
                    data=existing.to_namespace_dict(), message="Ya está en favoritos"
                )
            ...
            return APIResponse.error(
                message="Error al agregar favorito", status_code=500
            )
    ...
    def delete(self):
        ...
        try:
            ...
            return APIResponse.error(
                message="Error al eliminar favoritos", status_code=500
            )
...
class UserFavoriteResource(Resource):
    ...
    def delete(self, favorite_id):
        ...
        try:
            ...
            if not fav:
                return APIResponse.error(
                    message="Favorito no encontrado", status_code=404
                )
            fav.delete()
            ...
            return APIResponse.error(
                message="Error al eliminar favorito", status_code=500
            )
...
class EndpointHistory(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            recent = (
                UserFavorite.query.filter_by(user_id=user_id)
                .order_by(UserFavorite.updated_at.desc())
                .limit(limit)
                .all()
            )
            return APIResponse.success(
            ...
            return APIResponse.error(
                message="Error al obtener historial", status_code=500
            )
    ...
    def post(self):
        ...
        try:
            ...
            return APIResponse.error(
                message="Error al agregar al historial", status_code=500
            )
