...
LIBRARY_PATH = os.getenv(
    "LIBRARY_PROJECTS_PATH", r"C:\Users\Miguel\Documents\Aplicaciones\_library"
)

projects_ns = Namespace(
    "projects", description="🧰 Proyectos locales (_library)", path="/projects"
)

launch_model = projects_ns.model(
    "LaunchProject",
    {
