...
class Medications(BaseModel):
    ...
    _namespace_fields = ['id', 'name', 'description', 'dosis', 'indications', 'contraindications', 'route_administration_id', 'finca_id', 'availability', 'created_at']
    ...
    _filterable_fields = ['route_administration_id', 'finca_id', 'availability', 'created_at']
