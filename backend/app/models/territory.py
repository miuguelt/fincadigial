...
class Territory(BaseModel):
    ...
    connectivity_level = db.Column(
        db.Enum(ConnectivityLevel),
        nullable=False,
        default=ConnectivityLevel.INTERMITTENT,
    )
...
class CommunityNode(BaseModel):
    ...
    __table_args__ = (db.Index("ix_community_nodes_finca_id", "finca_id"),)
