...
class FoodTypes(BaseModel):
    ...
    _namespace_fields = ['id', 'food_type', 'sowing_date', 'harvest_date', 'area', 'handlings', 'gauges', 'finca_id', 'created_at']
    _namespace_relations = {
        'fields': {'fields': ['id', 'name', 'state'], 'depth': 1}
    }
    _searchable_fields = ['food_type', 'handlings']
    _filterable_fields = ['sowing_date', 'harvest_date', 'area', 'finca_id', 'created_at']
