...
class Diseases(BaseModel):
    ...
    _namespace_fields = ["id", "name", "symptoms", "details", "finca_id", "created_at"]
    ...
    _filterable_fields = ["finca_id", "created_at"]
    ...
    animals = db.relationship(
        "AnimalDiseases", back_populates="disease", lazy="dynamic"
    )
