...
class ActivityLog(BaseModel):
    ...
    __table_args__ = (
        ...
        db.Index(
            "ix_activity_log_actor_entity_created_at",
            "actor_id",
            "entity",
            "created_at",
        ),
        db.Index(
            "ix_activity_log_actor_action_created_at",
            "actor_id",
            "action",
            "created_at",
        ),
        db.Index(
            "ix_activity_log_actor_severity_created_at",
            "actor_id",
            "severity",
            "created_at",
        ),
        db.Index(
            "ix_activity_log_actor_animal_created_at",
            "actor_id",
            "animal_id",
            "created_at",
        ),
        db.Index("ix_activity_log_finca_id", "finca_id"),
    )
