...
class ProducerProfile(BaseModel):
    ...
    producer_type = db.Column(
        db.Enum(ProducerType), nullable=False, default=ProducerType.Subsistencia
    )
    ...
    user = db.relationship(
        "User", backref=db.backref("producer_profile", uselist=False), lazy="selectin"
    )
