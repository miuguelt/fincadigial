...
class WeatherRecord(BaseModel):
    ...
    _namespace_fields = [
        "id", "finca_id", "recorded_at", "temperature_celsius", "feels_like_celsius",
        "humidity_percent", "wind_speed_kmh", "wind_direction_degrees", "precipitation_mm",
        "pressure_hpa", "uv_index", "cloud_cover_percent", "weather_code", "weather_condition",
        "sunrise_time", "sunset_time", "latitude", "longitude", "source", "created_at", "updated_at",
    ]
...
class WeatherAlert(BaseModel):
    ...
    severity = db.Column(db.Enum(WeatherAlertSeverity), nullable=False, default=WeatherAlertSeverity.MEDIUM)
    ...
    finca = db.relationship("Finca", lazy="selectin")
    dismissed_user = db.relationship("User", foreign_keys=[dismissed_by], lazy="selectin")

    _namespace_fields = [
        "id", "finca_id", "title", "alert_type", "severity", "description",
        "recommendation", "current_temperature", "current_humidity", "current_wind_speed",
        "valid_from", "valid_until", "is_active", "is_dismissed", "dismissed_by",
        "dismissed_at", "source", "created_at", "updated_at",
    ]
    ...
    _filterable_fields = ["finca_id", "alert_type", "severity", "is_active", "is_dismissed"]
